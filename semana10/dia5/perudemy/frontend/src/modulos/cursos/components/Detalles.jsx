                ...
                <div class="uk-container">
                    ...
                    <div class="flex lg:flex-row flex-col gap-x-12">
                        ...
                        <div class="lg:w-8/12 text-white relative lg:mt-0 mt-12">
                            ...
                            <h1 class="text-white leading-10">The Complete JavaScript From beginning to advance</h1>
                            <p class="text-lg"> Master JavaScript with the most complete course! Projects Excellent course.
                                we explain the core concepts in javascript
                            ...
                            <ul class="flex text-gray-300">
                                <li> Created by <a href="#" class="text-white fond-bold"> Stella Johnson </a> </li>
            ...
            <div class="bg-white shadow w-full course-tab" uk-sticky="offset: 75 ; media: @m ; bottom : true">
                <div class="max-w-3xl m-auto px-4">
                    <ul class="uk-child-width-expand uk-tab m-0"
                        ...
                        <li><a href="#"><i class="uil-file-blank icon-mobi"></i> <span> Overview </span></a></li>
                        <li><a href="#"> <i class="uil-play-circle icon-mobi"></i> <span> Curriculum</span></a></li>
                        ...
                        <li><a href="#"> <i class="uil-star icon-mobi"></i> <span> Reviews</span></a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <li>
                        ...
                        <ul uk-accordion>
                            <li class="bg-white px-6 py-4 rounded shadow hover:shadow-md uk-open">
                                <a class="uk-accordion-title text-md" href="#"> Html Introduction </a>
                                <div class="uk-accordion-content mt-3 -mx-6">
                                    ...
                                    <ul class="course-curriculum-list font-semibold">
                                        ...
                                        <li class="hover:bg-gray-200 px-6 py-2 flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                ...
                                                <path fill-rule="evenodd"
                                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z"
                                                    clip-rule="evenodd" />
                                            </svg> What is HTML <span class="text-sm ml-auto"> 23 min </span>
                                        </li>
                                        <li class="hover:bg-gray-200 px-6 py-2 flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                class="w-6 mr-2">
                                            ...
                                            What is a Web page? <span class="text-sm ml-auto"> 23 min </span>
                                        </li>
                                        <li class="hover:bg-gray-200 px-6 py-2 flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                class="w-6 mr-2">
                                            ...
                                            Your First Web Page <a href="#trailer-modal"
                                                class="bg-teal-100 border border-green-200 ml-2 px-3 rounded text-green-600 text-xs"
                                                uk-toggle> Preview </a>
                                        ...
                                        <li class="hover:bg-gray-200 px-6 py-2 flex">
                                            ...
                                            Brain Streak <span class="text-sm ml-auto"> 23 min </span>
                                        </li>
                                    </ul>
                            ...
                            <li class="bg-white px-6 py-4 rounded shadow hover:shadow-md">
                                <a class="uk-accordion-title text-md" href="#"> Your First webpage </a>
                                <div class="uk-accordion-content mt-3 -mx-6">
